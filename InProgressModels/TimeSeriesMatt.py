...
y_data = np.array(price_values[:len(x_data)])  # Use the first 5 elements of price_values for y1_data
...
popt1, pcov1 = curve_fit(model_f, x_data, y_data, p0=initial_guess)
